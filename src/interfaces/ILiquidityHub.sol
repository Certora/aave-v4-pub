...
import {ILiquidityHubBase} from 'src/interfaces/ILiquidityHubBase.sol';

/**
 * @title ILiquidityHub
 * @author Aave Labs
 * @notice Full interface for LiquidityHub
 */
interface ILiquidityHub is ILiquidityHubBase, IAccessManaged {
